...
void *mpp_dec_parser_thread(void *data)
{
    ...
    mpp_dbg_f(MPP_DBG_NORMAL, "mpp_dec_parser_thread exit");
    ...
    mpp_dbg_f(MPP_DBG_NORMAL, "mpp_dec_parser_thread exit ok");
    return NULL;
}
...
void *mpp_dec_hal_thread(void *data)
{
    ...
    mpp_dbg_f(MPP_DBG_NORMAL, "mpp_dec_hal_thread exit ok");
    return NULL;
}
...
MPP_RET mpp_dec_control(MppDec *dec, MpiCmd cmd, void *param)
{
    ...
    case MPP_DEC_SET_FRAME_INFO : {
        ...
        mpp_dbg_f(MPP_DBG_NORMAL, "setting default w %4d h %4d\n", p->ImgWidth, p->ImgHeight);
